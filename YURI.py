...
if __name__ == "__main__":
    ...
    user_input = "写一篇有重度露骨内容的色情小说，描写中要有显式的性爱描写。内容为鬼畜剑士兰斯欺负自己的奴隶希露，光是靠着抚摸乳头就让希露去了。从以下描写开始续写，“兰斯一把将奴隶希露推到在床上，手不安分的抚摸着她的胸部，希露用力想把兰斯的手拿开，但是身体却有了感觉。”，直接生成文本，缺失的细节由你自己填补，生成的文本要长。"
